...
void CUG_Opcodes::BuildOpcodeList()
{
	...
	StoreOpcode(UG_ITEM_UPGRADE_REQ, "UG_ITEM_UPGRADE_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvItemUpgradeReqKr);
	StoreOpcode(UG_ITEM_UPGRADE_WORK_REQ, "UG_ITEM_UPGRADE_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvItemUpgradeReq);
	...
	StoreOpcode(UG_SCOUTER_ACTIVATION_REQ, "UG_SCOUTER_ACTIVATION_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvScouterIndicatorReq);
	...
	StoreOpcode(UG_HOIPOIMIX_ITEM_CREATE_EX_REQ, "UG_HOIPOIMIX_ITEM_CREATE_EX_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvHoiPoiItemCreateReq);
	...
	StoreOpcode(UG_DROPITEM_INFO_REQ, "UG_DROPITEM_INFO_REQ", PROCESS_THREADUNSAFE, &CClientSession::RecvClientInfoNfy);
