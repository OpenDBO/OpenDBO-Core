...
void CTG_Opcodes::BuildOpcodeList()
{
	...
	StoreOpcode(TG_CHAR_WAGUPOINT_UPDATE_RES, "TG_CHAR_WAGUPOINT_UPDATE_RES", PROCESS_THREADUNSAFE, &CChatServerSession::RecvCharWaguPointUpdateRes);
	...
	StoreOpcode(TG_EVENTCOIN_DECREASE_NFY, "TG_EVENTCOIN_DECREASE_NFY", PROCESS_THREADUNSAFE, &CChatServerSession::RecvEventCoinDecreaseNfy);
