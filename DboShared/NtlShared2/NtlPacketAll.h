...
/*
	...
	1) Naming Op-code
		...
		To distinguish type of a packet from other types, we use some alphabet letters in op-codes.
			...
			L - Log Server
			P - Operating Server
			S - System Tool(Admin Tool)
			E - Server Agent
			O - Server Agent Controller
			R - Game Report Server
			B - Bot Master
			X - UNDEFINED SERVER
	...
	2) Ranges that Op-code values belong to.
		...
		MQ series packets' Op code should be in [16000, 16999].
		QM series packets' Op code should be in [17000, 17999].
