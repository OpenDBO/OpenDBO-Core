...
const char * s_packetName_UG[] =
{
	...
	DECLARE_PACKET_NAME(UG_CHAR_STANDING_SLIP),
	...
	DECLARE_PACKET_NAME(UG_SCOUTER_ACTIVATION_REQ),
	...
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_ITEM_GET_REQ),
	...
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_REQUEST_REQ),
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_CONSENT_RES),
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY),
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_REQ),
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_REQ),
	DECLARE_PACKET_NAME(UG_PRIVATESHOP_BUSINESS_CANCEL_REQ),
	...
	DECLARE_PACKET_NAME(UG_HOIPOIMIX_ITEM_CREATE_EX_REQ),
	...
	DECLARE_PACKET_NAME(UG_CASHITEM_UPDATE_DURATION_REQ),
	DECLARE_PACKET_NAME(UG_CHAR_DEST_MOVE_SYNC),
	DECLARE_PACKET_NAME(UG_CHAR_NPCSERVER_MOVE_SYNC),
	...
	DECLARE_PACKET_NAME(UG_MASCOT_SUMMON_REQ),
	DECLARE_PACKET_NAME(UG_MASCOT_UNSUMMON_REQ),
	DECLARE_PACKET_NAME(UG_MASCOT_DELETE_REQ),
	...
	DECLARE_PACKET_NAME(UG_CASHITEM_INFO_REQ),
	...
	DECLARE_PACKET_NAME(UG_ITEM_UPGRADE_WORK_REQ),
	DECLARE_PACKET_NAME(UG_ITEM_UPGRADE_PROBABLEITEM_REQ),
	DECLARE_PACKET_NAME(UG_REQUEST_CHAR_HISTORY_DATA_REQ),
	DECLARE_PACKET_NAME(UG_EVENT_REWARD_LOAD_REQ),
	DECLARE_PACKET_NAME(UG_EVENT_REWARD_SELECT_REQ),
	DECLARE_PACKET_NAME(UG_DROPITEM_INFO_REQ),
	...
	DECLARE_PACKET_NAME(UG_GAMEGUARD3_AUTH_ANSWER_RES),
	...
	DECLARE_PACKET_NAME(UG_PERFORMANCE_DATA_NFY),
	DECLARE_PACKET_NAME(UG_PERFORMANCE_DATA_2_NFY),
	...
	DECLARE_PACKET_NAME(UG_CHAR_AIR_POSE_REQ),
	...
	DECLARE_PACKET_NAME(UG_CLIENT_INFO_NFY), // TODO: To remove, DBOG's shit ~Nady
};
