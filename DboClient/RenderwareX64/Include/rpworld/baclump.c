...
/* Binary Representations (2004.11.8 gemani atomic�� uda save)*/
 ...
 * 2006. 7. 7. Nonstopdj
 * 
 * AgcmRender::m_listWorldClump ���� remove�� �� dirtylist������ ���������� �������ش�.
 */
RwBool
...
RpClumpGetFrame(const RpClump * clump)
{
	...
	// 2005.3.11 gemani FrameLocking �ڵ� ����
