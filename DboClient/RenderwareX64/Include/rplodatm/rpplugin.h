...
extern long rpLodatmStackDepth;
#define RWDEBUGSTACKDEPTH rpLodatmStackDepth
...
#define rwPLUGIN_ID      rwID_LODATMPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionLODATM
#define rwPLUGIN_ERRENUM e_rwdb_CriterionLODATM
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionLODATMLAST
