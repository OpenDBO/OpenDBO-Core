================================================================================
              MFC 라이브러리 : NtlWE 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 NtlWE 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 NtlWE 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
NtlWE.h
    ...
    특정 헤더가 포함되며 CNtlWEApp 응용 프로그램 클래스가 선언됩니다.

NtlWE.cpp
    CNtlWEApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\NtlWE.ico
    ...
    이 아이콘은 주 리소스 파일인 NtlWE.rc에 포함됩니다.
...
NtlWEFrm.h, NtlWEFrm.cpp
    CNtlWEFrm 프레임 클래스를 포함하는 파일입니다.
    프레임 클래스는 CFrameWnd에서 파생되며 모든 SDI 프레임 기능을 제어합니다.
res\Toolbar.bmp
    도구 모음에 바둑판식 이미지를 만들 때 사용되는 비트맵 파일입니다.
    초기 도구 모음 및 상태 표시줄은 CNtlWEFrm 클래스에 구성됩니다.
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 NtlWE.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

NtlWEDoc.h, NtlWEDoc.cpp - 문서
    CNtlWEDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CNtlWEDoc::Serialize 사용).
NtlWEView.h, NtlWEView.cpp - 문서 뷰
    CNtlWEView 클래스를 포함하는 파일입니다.
    CNtlWEView 개체를 사용하여 CNtlWEDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) NtlWE.pch 및 미리 컴파일된
