...
bool CreateTableContainer(const char* pPath, CTable::eLOADING_METHOD eLoadingMethod)
{
	...
	flagManager.Set(CTableContainer::TABLE_TEXT_ALL); // <--- translated name itens
	...
	fileNameList.SetFileName(CTableContainer::TABLE_TEXT_ALL, "Table_Text_All_Data");// <--- translated name itens
