// TextureConverter.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CTextureConverterApp 개체입니다.

CTextureConverterApp theApp;

// CTextureConverterApp 초기화
