...
{
    //CString skinPath = L".\\Tool\\ModelTool\\Styles\\WinXP.Royale.cjstyles";
    CString skinPath = L".\\Vista.cjstyles";
...
int CMainFrame::OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl)
{
    if (lpCreateControl->bToolBar)
    {
        ...
        if (lpCreateControl->nID == ID_TOOL_CAMERA_SENSE)
        {
            ...
            m_pEditCamraSense->SetEditText(L"2.0");            
        ...
        else if(lpCreateControl->nID == ID_TOOL_THICKNESS)
        {
            ...
            m_pEditToonThickness->SetEditText(L"1.2");
...
void CMainFrame::OnCameraSense()
{
    if(CModelToolApplication::GetInstance())
    {
        ...
        RwReal fCameraSense = (RwReal)_wtof(strCameraSense);
...
void CMainFrame::OnToonThickness() 
{
    if(CModelToolApplication::GetInstance())
    {
        ...
        RwReal fThickness = (RwReal)_wtof(strThickness);
