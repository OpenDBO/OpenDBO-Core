...
CDLSkinDlg_CJIKor::CDLSkinDlg_CJIKor( void )
{
...
bool CDLSkinDlg_CJIKor::CreateDlg( void )
{
	return Create( IDD_SKIN_CJI_KOR_DLG, NULL ) ? TRUE : FALSE;
}

void CDLSkinDlg_CJIKor::DLMessageProc( eDL_EVENT eMsg, sDL_EVENT_DATA_BASE* pData )
{
...
void CDLSkinDlg_CJIKor::DoDataExchange( CDataExchange* pDX )
{
	CDLSkinBaseDlg::DoDataExchange( pDX );

	DDX_Control( pDX, IDC_CJI_KOR_EXPLORER_INFORMATION, m_ctrExplorerInfo );
	DDX_Control( pDX, IDC_CJI_KOR_DOWNLOAD, m_ctrDownload );
	DDX_Control( pDX, IDC_CJI_KOR_PATCH, m_ctrPatch );
	DDX_Control( pDX, IDC_CJI_KOR_DOWNLOAD_INFO, m_ctrDownloadInfo );
	DDX_Control( pDX, IDC_CJI_KOR_LOG, m_ctrLog );
	DDX_Control( pDX, IDC_CJI_KOR_CANCEL, m_ctrCancel );
	DDX_Control( pDX, IDC_CJI_KOR_GAME_START, m_ctrGameStart );
	DDX_Control( pDX, IDC_CJI_KOR_GAME_TEST, m_ctrGameIntegrity );
}

BOOL CDLSkinDlg_CJIKor::OnInitDialog( void )
{
...
BOOL CDLSkinDlg_CJIKor::DestroyWindow( void )
{
	if ( m_hIcon )
	{
...
void CDLSkinDlg_CJIKor::OnPaint( void )
{
	if ( IsIconic() )
	{
		CPaintDC dc( this );
...
HCURSOR CDLSkinDlg_CJIKor::OnQueryDragIcon( void )
{
	return (HCURSOR)m_hIcon;
}

void CDLSkinDlg_CJIKor::OnClose( void )
{
	sDL_ED_USER_EXIT sEDUserExit;
	DLSendEvent( eDL_EVENT_USER_EXIT, &sEDUserExit );
}

void CDLSkinDlg_CJIKor::OnBnClickedCJIKorGameStart( void )
{
...
void CDLSkinDlg_CJIKor::OnBnClickedCJIKorCancel( void )
{
	sDL_ED_USER_EXIT sEDUserExit;
	DLSendEvent( eDL_EVENT_USER_EXIT, &sEDUserExit );
}

void CDLSkinDlg_CJIKor::OnBnClickedCJIKorIntegrityCheck( void )
{
...
BEGIN_MESSAGE_MAP( CDLSkinDlg_CJIKor, CBitmapDlg )
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CLOSE()
	ON_BN_CLICKED( IDC_CJI_KOR_GAME_START, &CDLSkinDlg_CJIKor::OnBnClickedCJIKorGameStart )
	ON_BN_CLICKED( IDC_CJI_KOR_CANCEL, &CDLSkinDlg_CJIKor::OnBnClickedCJIKorCancel )
	ON_BN_CLICKED( IDC_CJI_KOR_GAME_TEST, &CDLSkinDlg_CJIKor::OnBnClickedCJIKorIntegrityCheck )
END_MESSAGE_MAP()
