...
CNtlPLCinematicFlash::CNtlPLCinematicFlash( CRectangle rtPos, gui::CComponent* pParent, RwChar* pFilename )
{
	...
	NTL_ASSERT( m_pFlash, "CNtlPLCinematicFlash::CNtlPLCinematicFlash : Flash Object fail to allocate" );
...
RwBool CNtlPLCinematicObject::Create(VOID)
{
	...
	if( !CNtlPLGui::Create( "", "gui\\Cinematic.srf", "gui\\Cinematic.frm" ) )
		NTL_RETURN( FALSE );

	CNtlPLGui::CreateComponents( GetNtlGuiManager()->GetGuiManager() );

	m_pThis = (gui::CDialog*)GetComponent( "dlgMain" );
	m_pFlashFrame = (gui::CFrame*)GetComponent( "frmFlash" );
	...
	//m_pClickAni = (gui::CAniPanel*)GetComponent( "aniMouseClick" );
	...
	//m_panpPCAniClick = (gui::CAniPanel*)GetComponent( "aniPCMouseClick" );
...
VOID CNtlPLCinematicObject::FitSizeToScreen( RwInt32 nWidth, RwInt32 nHeight )
{
	...
	// PC AniClick
	//m_panpPCAniClick->SetPosition( nWidth - m_panpPCAniClick->GetWidth() - PCANICLICKMOUSE_MARGIN_X,
	//							   m_pfrmPCFrame->GetHeight() - m_panpPCAniClick->GetHeight() - PCANICLICKMOUSE_MARGIN_Y );
}
