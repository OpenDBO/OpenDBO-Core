...
public:
	...
	gui::CFrame*		GetFlashFrame(VOID) { return m_pFlashFrame; }
	...
	//gui::CAniPanel*		GetClickAni(VOID) { return m_pClickAni; }

	gui::CDialog*		GetPCFrame(VOID) { return m_pfrmPCFrame; }
	gui::CHtmlBox*		GetPCMessage(VOID) { return m_phtmlPCMessage; }
	//gui::CAniPanel*		GetPCAniClick(VOID) { return m_panpPCAniClick; }
