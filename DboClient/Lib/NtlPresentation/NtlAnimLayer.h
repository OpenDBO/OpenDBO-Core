...
protected:
	...
	CNtlCallbackParam1	*m_pCallBack;
...
public:
	...
	void SetCallBack(Callbackclass *cbclass,int (Callbackclass::*callback)(unsigned int uiEventData))
	{
		m_pCallBack = NTL_NEW CNtlCallbackWidget1<Callbackclass> (cbclass,callback);
	}
