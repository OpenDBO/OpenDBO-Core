...
RpWorld* RpNtlWorldCreate()
{
	...
	RwBBox NtlWorldBBox = {	{(RwReal)dGET_WORLD_PARAM()->WorldValueMax, 768.0f, (RwReal)dGET_WORLD_PARAM()->WorldValueMax},
							{(RwReal)dGET_WORLD_PARAM()->WorldValueMin, -768.0f, (RwReal)dGET_WORLD_PARAM()->WorldValueMin}};
