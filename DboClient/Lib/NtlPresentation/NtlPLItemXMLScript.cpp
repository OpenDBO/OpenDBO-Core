...
RwBool CNtlPLItemXMLScript::SaveUpgradeEffect( CNtlPLItemProperty* pProperty ) 
{
    ...
    CNtlPLXMLScriptHelper::SaveAttribute(pElemUpgradeEffect, L"EFFECT_1", pUpgradeProp->szEffect1);
    CNtlPLXMLScriptHelper::SaveAttribute(pElemUpgradeEffect, L"EFFECT_2", pUpgradeProp->szEffect2);
...
RwBool CNtlPLItemXMLScript::LoadUpgradeEffect( CNtlPLItemProperty* pProperty ) 
{
    ...
    GetTextWithAttributeName(pNode, "EFFECT_1", szEffect1, sizeof(szEffect1));
    GetTextWithAttributeName(pNode, "EFFECT_2", szEffect2, sizeof(szEffect2));
    ...
    sprintf_s(pUpgradeProp->szEffect1, "%s", szEffect1);
    sprintf_s(pUpgradeProp->szEffect2, "%s", szEffect2);
