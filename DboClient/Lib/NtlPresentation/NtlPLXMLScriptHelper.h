...
public:
    ...
    RwBool  SaveTMQEvent(IXMLDOMElement* pElemEvent, const SEventTMQ* pEventTMQ);               ///< TMQ Event를 Save 한다.
    RwBool  LoadTMQEvent(IXMLDOMNode* pNodeEvent, SEventTMQ* pEventTMQ);
