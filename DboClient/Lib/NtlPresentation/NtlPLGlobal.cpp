...
RwReal		g_fCharScheduleTime = 0.03f;
...
RwReal						CNtlPLGlobal::m_fDistFiterObjFrequency = 1.0f;	// 占쏙옙占쏙옙占쏙옙트 占쏙옙占싱듸옙 占쏙옙占쏙옙占쏙옙 타占쏙옙
...
RwBool						CNtlPLGlobal::m_bObjectRender = TRUE;              ///< Object Render 占쏙옙占쏙옙 占시뤄옙占쏙옙
