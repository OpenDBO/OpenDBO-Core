...
public:
	...
	void			AddBuff(eDBO_OBJECT_SOURCE eType, RwUInt32 uiTableIndex, RwReal fRemainTime, RwReal* pfEffectValue = NULL);
	void			DropBuff(eDBO_OBJECT_SOURCE eType, RwUInt32 uiTableIndex);
