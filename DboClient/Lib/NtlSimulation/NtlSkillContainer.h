...
public:
	...
	RwBool CanDash(RwUInt16& wDashReqLP, RwUInt16& wDashReqEP, RwUInt16& wDashReqRP);

	RwBool CanCharging(void);
	RwBool CanBlocking(void);
};

inline RwBool CNtlAvatarSkillContainer::CanDash(RwUInt16& wDashReqLP, RwUInt16& wDashReqEP, RwUInt16& wDashReqRP)
{
	wDashReqLP = m_wDashReqLP;
...
inline RwBool CNtlAvatarSkillContainer::CanCharging(void)
{
	return m_bChargingPossible;
}

inline RwBool CNtlAvatarSkillContainer::CanBlocking(void)
{
