...
class CNtlBHVehicleSpawnVehicle : public CNtlBHVehicleEntity
{
protected:
	RwV3d						m_vSpawnPos;
	RwV3d						m_vSpawnDir;
	...
	RwBool						m_bFinish;
	RwReal						m_fShowingTime;

public:
	CNtlBHVehicleSpawnVehicle( CNtlSobActor* pDriver, CNtlSobVehicle* pVehicle )
		: CNtlBHVehicleEntity( pDriver, pVehicle ) { return; }

	virtual ~CNtlBHVehicleSpawnVehicle( void ) { return; }
...
class CNtlBHVehicleCharRunToVehicle : public CNtlBHVehicleEntity
{
protected:
	RwBool						m_bFinish;

	RwV3d						m_vCurDirverPos;
	RwV3d						m_vRunDir;

	RwReal						m_fTargetDist;
	RwReal						m_fRemainDist;

public:
	CNtlBHVehicleCharRunToVehicle( CNtlSobActor* pDriver, CNtlSobVehicle* pVehicle )
		: CNtlBHVehicleEntity( pDriver, pVehicle ) { return; }

	virtual ~CNtlBHVehicleCharRunToVehicle( void ) { return; }
...
class CNtlBHVehicleCharRideOnVehicle : public CNtlBHVehicleEntity
{
protected:
	RwBool						m_bFinish;
	...
	RwReal						m_fRideOnSpeed;

public:
	CNtlBHVehicleCharRideOnVehicle( CNtlSobActor* pDriver, CNtlSobVehicle* pVehicle )
		: CNtlBHVehicleEntity( pDriver, pVehicle ) { return; }

	virtual ~CNtlBHVehicleCharRideOnVehicle( void ) { return; }
