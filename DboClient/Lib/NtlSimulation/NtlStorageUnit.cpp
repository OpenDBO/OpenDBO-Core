...
bool CNtlStorageUnit::Create( eNTL_STORAGE_TYPE eType )
{
	...
	case eNTL_STORAGE_CHAT:
		...
		break;
	case eNTL_STORAGE_EXTRAFILTER:														// New Filter (Extra Tab)
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_RARITY_NORMAL);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_RARITY_SUPERIOR);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_RARITY_EXCELLENT);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_RARITY_RARE);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_RARITY_LEGENDARY);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_BLUE);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_RED);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_GREEN);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_PURPLE);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_WHITE);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_ADOWN);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_STONE_WDOWN);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_MYSTERYITEM);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_FILTER_CONSUMABLE);
		break;
...
bool CNtlStorageUnit::Reset()
{
	...
	case eNTL_STORAGE_CHAT:
		...
		return true;
	case eNTL_STORAGE_EXTRAFILTER:										// New Filter (Extra Tab)
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_RARITY_NORMAL);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_RARITY_SUPERIOR);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_RARITY_EXCELLENT);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_RARITY_RARE);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_RARITY_LEGENDARY);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_BLUE);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_RED);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_GREEN);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_PURPLE);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_WHITE);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_ADOWN);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_STONE_WDOWN);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_MYSTERYITEM);
		CHANGE_RESET_VALUE(dSTORAGE_FILTER_CONSUMABLE);
		return true;
	case eNTL_STORAGE_SCOUTER:
