...
CNtlSobActor* Logic_GetAutoTarget(CNtlSobActor* pActor)
{
    ...
    if ( pSobGroup )
    {
        ...
        if(!vecTargetList.empty())
        {
            ...
            if(pNearTargetActor != vecTargetList[0]->pActor)        // ���� ����� Ÿ���� ����Ǹ� ���� Ÿ�����Ѵ�. (ĳ���� �̵�, �� ��ġ ����)
            {
                nTargetIndex = 0;                                
...
void Logic_ProcWorldLight(CNtlSobActor *pActor, RwV3d vPos)
{
	...
	{
		// pActor�� Object ���� �ְ� SelfShadow(FALSE)��� Shadow�� �������� �ʴ´�.
...
RwBool Logic_CanTranslateIdleState( CNtlSobActor* pActor ) 
{
	...
	if(nStateId == NTL_FSMSID_ONBUS)            // ������ ��쿡�� �ȵ�
		return FALSE;

	if(nStateId == NTL_FSMSID_ONVEHICLE)        // Ż���� ��쿡�� �ȵ�
		return FALSE;

    if(nStateId == NTL_FSMSID_KNOCKDOWN)        // �˴ٿ��� ��쿡�� �ȵ�
        return FALSE;
