...
public:
	...
	bool				IsNormalStart()			{ return m_sHoipoiMixData.bNormalStart; }
	bool				IsSpecialStart()		{ return m_sHoipoiMixData.bSpecialStart; }
	RwUInt8				GetSpecialType()		{ return m_sHoipoiMixData.bySpecialType; }
	RwUInt8				GetMixLevel()			{ return m_sHoipoiMixData.byMixLevel; }
	RwUInt32			GetMixExp()				{ return m_sHoipoiMixData.dwMixExp; }
	
protected:
	void				ClearRecipeData();
	void				ClearSpecialRecipeData();
