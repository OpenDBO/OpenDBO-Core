...
struct sGuildNotice
{
	WCHAR awcCharName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];
	WCHAR awcNotice[NTL_MAX_LENGTH_OF_GUILD_NOTICE_UNICODE + 1];
};
...
protected:
	WCHAR					m_wszGuildName[NTL_MAX_SIZE_GUILD_NAME_IN_UNICODE+1];	///< 길드 이름
