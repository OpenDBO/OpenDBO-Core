...
{dSTORAGE_GAMEINFO_ITEM_DROP,		eBOOL,		eNTL_STORAGE_GAMEINFO,	"ITEM_DROP",		NULL,	"true"},
...
// New Filter (Extra Tab)
{dSTORAGE_FILTER_RARITY_NORMAL,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_NORMAL",    NULL, "false"},
{dSTORAGE_FILTER_RARITY_SUPERIOR,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_SUPERIOR",  NULL, "false"},
{dSTORAGE_FILTER_RARITY_EXCELLENT,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_EXCELLENT", NULL, "false"},
{dSTORAGE_FILTER_RARITY_RARE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_RARE",      NULL, "false"},
{dSTORAGE_FILTER_RARITY_LEGENDARY,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_LEGENDARY", NULL, "false"},
{dSTORAGE_FILTER_STONE_BLUE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_BLUE",		 NULL, "false"},
{dSTORAGE_FILTER_STONE_RED,			eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_RED",		 NULL, "false"},
{dSTORAGE_FILTER_STONE_GREEN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_GREEN",		 NULL, "false"},
{dSTORAGE_FILTER_STONE_PURPLE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_PURPLE",     NULL, "false"},
{dSTORAGE_FILTER_STONE_WHITE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_WHITE",		 NULL, "false"},
{dSTORAGE_FILTER_STONE_ADOWN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_ADOWN",		 NULL, "false"},
{dSTORAGE_FILTER_STONE_WDOWN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_WDOW",		 NULL, "false"},
{dSTORAGE_FILTER_MYSTERYITEM,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_MYSTERYITEM",		 NULL, "false"},
{dSTORAGE_FILTER_CONSUMABLE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_CONSUMABLE",		 NULL, "false"},
