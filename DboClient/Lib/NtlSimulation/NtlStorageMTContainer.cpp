...
{dSTORAGE_FILTER_RARITY_NORMAL,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_NORMAL",    NULL, "true"},
{dSTORAGE_FILTER_RARITY_SUPERIOR,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_SUPERIOR",  NULL, "true"},
{dSTORAGE_FILTER_RARITY_EXCELLENT,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_EXCELLENT", NULL, "true"},
{dSTORAGE_FILTER_RARITY_RARE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_RARE",      NULL, "true"},
{dSTORAGE_FILTER_RARITY_LEGENDARY,	eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_RARITY_LEGENDARY", NULL, "true"},
{dSTORAGE_FILTER_STONE_BLUE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_BLUE",		 NULL, "true"},
{dSTORAGE_FILTER_STONE_RED,			eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_RED",		 NULL, "true"},
{dSTORAGE_FILTER_STONE_GREEN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_GREEN",		 NULL, "true"},
{dSTORAGE_FILTER_STONE_PURPLE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_PURPLE",     NULL, "true"},
{dSTORAGE_FILTER_STONE_WHITE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_WHITE",		 NULL, "true"},
{dSTORAGE_FILTER_STONE_ADOWN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_ADOWN",		 NULL, "true"},
{dSTORAGE_FILTER_STONE_WDOWN,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_STONE_WDOW",		 NULL, "true"},
{dSTORAGE_FILTER_MYSTERYITEM,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_MYSTERYITEM",		 NULL, "true"},
{dSTORAGE_FILTER_CONSUMABLE,		eBOOL,		eNTL_STORAGE_EXTRAFILTER, "FILTER_CONSUMABLE",		 NULL, "true"},
