...
_rwOpenGLVertexHeapCreate( void )
{
    ...
    if ( _rwOpenGLVertexHeapAvailable() )
    {
        ...
        endOfVideoMemory = (void *)(OPENGLVERTEXHEAP_ALIGNTO32BYTES( (uintptr_t)endOfVideoMemory ));
        openGLFreeBlockStart->blockSize = (RwUInt32)((uintptr_t)(endOfVideoMemory) - (uintptr_t)openGLVertexHeapMemory);
