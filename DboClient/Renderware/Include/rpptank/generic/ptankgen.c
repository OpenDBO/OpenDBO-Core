 ...
 *****************************************************************************
 * NOTE (x64 D3D9 port):
 * defaultCB / PTankOpen / PTankClose are platform-specific and are defined
 * in the D3D9 backend (ptankd3d9.c). They are deliberately NOT defined here
 * anymore: leaving the generic no-op versions caused the linker to pick them
 * instead of the D3D9 ones, so particles/smoke had no render callback and
 * never drew. Only the D3D9 backend must provide these symbols.
 */
