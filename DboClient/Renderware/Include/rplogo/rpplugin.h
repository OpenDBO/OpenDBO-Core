...
extern long rpLogoStackDepth;
#define RWDEBUGSTACKDEPTH rpLogoStackDepth
...
#define rwPLUGIN_ID      rwID_LOGOPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionLogo
#define rwPLUGIN_ERRENUM e_rwdb_CriterionLogo
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionLogoLAST
