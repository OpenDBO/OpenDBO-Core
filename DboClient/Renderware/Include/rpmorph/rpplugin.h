...
extern long rpMorphStackDepth;
#define RWDEBUGSTACKDEPTH rpMorphStackDepth
...
#define rwPLUGIN_ID      rwID_MORPHPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionMorph
#define rwPLUGIN_ERRENUM e_rwdb_CriterionMorph
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionMorphLAST
