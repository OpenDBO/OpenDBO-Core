...
extern long _rpPatchStackDepth;
#define RWDEBUGSTACKDEPTH _rpPatchStackDepth
...
#define rwPLUGIN_ID            rwID_PATCHPLUGIN
#define rwPLUGIN_ERRFUNC      _rwdb_CriterionPATCH
#define rwPLUGIN_ERRENUM     e_rwdb_CriterionPATCH
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionPATCHLAST
