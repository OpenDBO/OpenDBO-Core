...
/* Binary Representations (2004.11.8 gemani atomicï¿½ï¿½ uda save)*/
        ...
        && (version <= rwLIBRARYCURRENTVERSION))
    {
        ...
        for (i = 0; i < gl; ++i)
        {
                ...
                && (version <= rwLIBRARYCURRENTVERSION))
            {
                ...
                {
                    char dbg[256];
                    sprintf_s(dbg, "GEOMETRY READ FAILED at index %d, version=0x%08x, LIBRARYBASE=0x%08x, CURRENT=0x%08x\n",
                        i, version, rwLIBRARYBASEVERSION, rwLIBRARYCURRENTVERSION);
                      ...
                      rpGeometryList * gl)
{
        ...
        (version <= rwLIBRARYCURRENTVERSION))
    {
		...
		//@{ Jaewon 20041222
		// ID ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Õ´Ï´ï¿½.. lodï¿½ï¿½ï¿½ï¿½ï¿½Ï¿ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ï´ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ 2005.3.1.
              ...
              RwInt32 size __RWUNUSED__ )
{
    ...
    if (RWCLUMPGLOBAL(atomicFreeList))
    {
        ...
        if (RWCLUMPGLOBAL(clumpFreeList))
        {
			...
			//. 2005. 12. 21. Nonstopdj
			//. Atomic Lockï¿½ï¿½Ã¼ ï¿½Ê±ï¿½È­
			CS_ATOMIC_INITLOCK();

			//. 2006. 1. 3. Nonstopdj
			//. ï¿½ï¿½ï¿½ï¿½ Geometry lockï¿½ï¿½Ã¼ ï¿½Ê±ï¿½È­
...
{
	// 2005.3.1 gemani RwLLLink ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Ã¼ ï¿½Ú·á±¸ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½
...
RpClumpForAllAtomics(RpClump * clump, RpAtomicCallBack callback, void *pData)
{
	...
	if(clump->atomicList)
	{
		...
		do
		{
			...
			if(next_atomic == NULL)
			{
				// List is corrupted after this node, treat as end
				end = TRUE;
				next_atomic = NULL;
			}
 ...
 * 2006. 7. 7. Nonstopdj
 * 
 * AgcmRender::m_listWorldClump ï¿½ï¿½ï¿½ï¿½ removeï¿½ï¿½ ï¿½ï¿½ dirtylistï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ø´ï¿½.
 */
RwBool
...
RpClumpStreamRead(RwStream * stream)
{
        ...
        (version <= rwLIBRARYCURRENTVERSION))
    {
        ...
        for (i = 0; i < cl.numLights; ++i)
        {
            ...
            if (frameIndex >= 0 && frameIndex < fl.numFrames && fl.frames)
            {
...
RpClumpGetFrame(const RpClump * clump)
{
	...
	// 2005.3.11 gemani FrameLocking ï¿½Úµï¿½ ï¿½ï¿½ï¿½ï¿½
