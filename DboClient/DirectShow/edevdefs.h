...
// returns indication of device뭩 synchronization accuracy.
...
// returns device뭩 normal framerate.
...
#define ED_TRANSCAP_CAN_SET_EE			ED_BASE+103L	// show device뭩 input on its output
#define ED_TRANSCAP_CAN_SET_PB			ED_BASE+104L	// show media playback on device뭩 output
...
#define ED_TRANSCAP_NEEDS_TBC			ED_BASE+113L	// device뭩 output not stable
...
#define ED_BOTTOM				0x0004			// or뭗  with
