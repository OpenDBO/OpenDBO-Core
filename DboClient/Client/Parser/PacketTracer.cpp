...
void CPacketTracer::Create()
{
	...
	m_mapPacketName.insert(PacketEnumNameMap::value_type(AU_HEARTBEAT, "AU_HEARTBEAT"));
	m_mapPacketName.insert(PacketEnumNameMap::value_type(AU_LOGIN_RES, "AU_LOGIN_RES"));
	m_mapPacketName.insert(PacketEnumNameMap::value_type(AU_LOGIN_CREATEUSER_RES, "AU_LOGIN_CREATEUSER_RES"));
	m_mapPacketName.insert(PacketEnumNameMap::value_type(AU_LOGIN_DISCONNECT_RES, "AU_LOGIN_DISCONNECT_RES"));

	m_mapPacketName.insert(PacketEnumNameMap::value_type(CU_HEARTBEAT, "CU_HEARTBEAT"));
	...
	PACKETNAME_INSERT( GU_CHAR_MOVE_SYNC );
	...
	PACKETNAME_INSERT( GU_CHAR_PUSHED_NFY );
	PACKETNAME_INSERT( GU_CHAR_FIGHTMODE );
	PACKETNAME_INSERT( GU_CHAR_BLOCK_MODE_COOL_TIME_NFY );
	PACKETNAME_INSERT( GU_CHAR_SITDOWN );
	PACKETNAME_INSERT( GU_CHAR_STANDUP );
	...
	PACKETNAME_INSERT( GU_UPDATE_TARGET_INFO );
	...
	PACKETNAME_INSERT( GU_SHOP_SKILL_BUY_RES );		// 스킬 구매 응답
	...
	PACKETNAME_INSERT( GU_PARTY_INVENTORY_INFO );
	PACKETNAME_INSERT( GU_PARTY_OPENED_CHARM_INVENTORY_INFO );
	...
	PACKETNAME_INSERT( GU_PARTY_OPEN_CHARM_SLOT_RES );
	PACKETNAME_INSERT( GU_PARTY_CHARM_SLOT_OPENED_NFY );
	PACKETNAME_INSERT( GU_PARTY_CLOSE_CHARM_SLOT_RES );
	PACKETNAME_INSERT( GU_PARTY_CHARM_SLOT_CLOSED_NFY );
	PACKETNAME_INSERT( GU_PARTY_REGISTER_VICTIM_ITEM_RES );
	PACKETNAME_INSERT( GU_PARTY_VICTIM_ITEM_REGISTERED_NFY );
	PACKETNAME_INSERT( GU_PARTY_UNREGISTER_VICTIM_ITEM_RES );
	PACKETNAME_INSERT( GU_PARTY_VICTIM_ITEM_UNREGISTERED_NFY );
	PACKETNAME_INSERT( GU_PARTY_REGISTER_VICTIM_ZENNY_RES );
	PACKETNAME_INSERT( GU_PARTY_VICTIM_ZENNY_REGISTERED_NFY );
	PACKETNAME_INSERT( GU_PARTY_UNREGISTER_VICTIM_ZENNY_RES );
	PACKETNAME_INSERT( GU_PARTY_VICTIM_ZENNY_UNREGISTERED_NFY );
	PACKETNAME_INSERT( GU_PARTY_DECLARE_ZENNY_RES );
	PACKETNAME_INSERT( GU_PARTY_DECLARED_ZENNY_CHANGED_NFY );
	PACKETNAME_INSERT( GU_PARTY_CHARM_ACTIVATION_FAILED_NFY );
	PACKETNAME_INSERT( GU_PARTY_ACTIVATE_CHARM_RES );
	PACKETNAME_INSERT( GU_PARTY_CHARM_ACTIVATED_NFY );
	PACKETNAME_INSERT( GU_PARTY_DEACTIVATE_CHARM_RES );
	PACKETNAME_INSERT( GU_PARTY_CHARM_DEACTIVATED_NFY );
	...
	PACKETNAME_INSERT( GU_PARTY_INVENTORY_ITEM_ADDED_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVENTORY_ITEM_REMOVED_NFY );
	PACKETNAME_INSERT( GU_PARTY_MEMBER_GAINED_ITEM_NFY );
	PACKETNAME_INSERT( GU_PARTY_MEMBER_GAINED_ZENNY_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEST_ZENNY_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEST_ZENNY_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVENTORY_ITEM_WINNER_CHANGED_NFY );
	PACKETNAME_INSERT( GU_PARTY_MEMBER_LOCATION_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_ITEM_RANK_SET_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_ITEM_RANK_SET_NFY );
	...
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_LIST_RES );						// 타임머신 퀘스트 방 목록 요청 응답
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_INFO_RES );						// 타임머신 퀘스트 방 정보 요청 응답
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_JOIN_RES );						// 타임머신 퀘스트 방 진입 요청 응답
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_JOIN_NFY );						// 타임머신 퀘스트 방 진입을 파티원에게 알림(파티장 제외)
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_LEAVE_RES );					// 타임머신 퀘스트 방 퇴장 요청 응답
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_LEAVE_NFY );					// 타임머신 퀘스트 방 퇴장을 파티원에게 알림(파티장 제외)
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_SELECTION_NFY );				// 타임머신 퀘스트 추첨
	PACKETNAME_INSERT( GU_TIMEQUEST_ROOM_TELEPORT_RES );					// 타임머신 퀘스트 시작 위치로 이동 응답
	...
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_LIST_RES );					// RankBattle 방 목록 요청
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_INFO_RES );					// RankBattle 방 정보 요청
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_CREATE_RES );					// RankBattle 방 생성 요청
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_CREATE_NFY );					// RankBattle 방이 생성되었음을 파티원에게 알림
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_LEAVE_RES );					// RankBattle 방 삭제 요청
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_LEAVE_NFY );					// RankBattle 방이 삭제되었음을 파티원에게 알림
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_JOIN_INFO_NFY );				// Party에 들어갔을 경우 RankBattle에 대한 참여 정보를 전송
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_CHALLENGE_RES );				// RankBattle 대련 요청
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_CHALLENGE_NFY );				// RankBattle 대련 요청 결과를 파티원에게 알림
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_MATCH_READY_NFY );				// RankBattle이 곧 시작됨을 알림
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_MATCH_START_NFY );				// RankBattle이 시작됨 - 경기장으로 이동
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_MATCH_CANCEL_RES );			// RankBattle 대전을 취소함(개인)
	PACKETNAME_INSERT( GU_RANKBATTLE_ROOM_MATCH_CANCELED_NFY );			// RankBattle 대전이 취소됨(owner 에게만 전송 ); 다시 대기상태로 변경)
	...
	PACKETNAME_INSERT( GU_DRAGONBALL_START_RES );						// 제단클릭
	...
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_REQUEST_RES );						// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_REQUEST_NFY );						// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_CONSENT_REQ );						// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_CONSENT_NFY );						// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY );					// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_RES );				// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_NFY );				// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_RES );			// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_NFY );			// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_WINDOWCLOSE_NFY );					// [2/4/2008 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_CANCEL_RES );							// [10/17/2007 SGpro]
	PACKETNAME_INSERT( GU_PRIVATESHOP_BUSINESS_CANCEL_NFY );							// [10/17/2007 SGpro]
	...
	PACKETNAME_INSERT( GU_PORTAL_START_RES );
	...
	PACKETNAME_INSERT( GU_CHAR_MARKING_NFY ); // 칭호 [9/10/2008 SGpro]
	PACKETNAME_INSERT( GU_PARTY_CHARM_DICE_START_NFY );					// 파티 다이스 UI 띄우고 시작하라
	PACKETNAME_INSERT( GU_PARTY_CHARM_DICE_ROLLED_NFY );					// 선택된 다이스 결과 방송
	PACKETNAME_INSERT( GU_PARTY_CHARM_DICE_ROLLED_RES );					// 선택된 다이스 결과
	PACKETNAME_INSERT( GU_PARTY_CHARM_DICE_END_NFY );					// 파티 다이스 선택시간 완료 및 총결과
	PACKETNAME_INSERT( GU_PARTY_INVEN_LOCK_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_LOCK_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_RESET_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_RESET_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_ACCEPTED_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_ACCEPTED_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_GIVE_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_GIVE_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_DICE_START_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_DICE_START_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_DICE_ROLL_RES );
	PACKETNAME_INSERT( GU_PARTY_INVEN_DICE_ROLL_NFY );
	PACKETNAME_INSERT( GU_PARTY_INVEN_DICE_END_NFY );
	...
	PACKETNAME_INSERT( GU_CHAR_NICKNAME_CHANGED_NFY );
	PACKETNAME_INSERT( GU_HOIPOIMIX_RECIPE_REG_NFY );					// 레시피등록
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_CHECK_RES );					// 만들아이템 선택 (필요한 아이템 수량 체크)
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_MAKE_RES );						// 아이템 만들기
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_MAKE_EP_RES );					// 아이템 만들기 중 EP 넣기
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_RECIPE_INFO );
	PACKETNAME_INSERT( GU_DYNAMIC_OBJECT_UPDATE_STATE );
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_MACHINE_MAKE_RES );
	PACKETNAME_INSERT( GU_HOIPOIMIX_ITEM_MACHINE_DEL_RES );
	...
	PACKETNAME_INSERT( GU_HOIPOIMIX_JOB_SET_RES );
	PACKETNAME_INSERT( GU_HOIPOIMIX_JOB_RESET_RES );
	...
	PACKETNAME_INSERT( GU_VEHICLE_ENGINE_START_RES );			// 탈 것 시동 켬 RES
	PACKETNAME_INSERT( GU_VEHICLE_ENGINE_START_NFY );			// 탈 것 시동 켬 브로드 캐스트
	PACKETNAME_INSERT( GU_VEHICLE_ENGINE_STOP_RES );
	PACKETNAME_INSERT( GU_VEHICLE_ENGINE_STOP_NFY );
	PACKETNAME_INSERT( GU_VEHICLE_FUEL_UPDATE_NFY );				// 탈 것 연료 사용 업데이트
	...
	PACKETNAME_INSERT( GU_DOJO_BANK_HISTORY_RES );
	...
	PACKETNAME_INSERT( TU_CHAT_MESSAGE_PRIVATESHOP_BUSINESS );		// 개인상점 흥정 채팅 [10/31/2007 SGpro]
	...
	PACKETNAME_INSERT( UA_LOGIN_REQ_KOREA_CJ );
	PACKETNAME_INSERT( UA_LOGIN_CREATEUSER_REQ );
	...
	PACKETNAME_INSERT( UG_CHAR_MOVE_SYNC );									// 캐릭터 위치 보정
	...
	PACKETNAME_INSERT( UG_CHAR_TOGG_RUNNING );								// 뛰기모드 토글 ( 현재 클라이언트는 사용하지 않음 )
	...
	PACKETNAME_INSERT( UG_SHOP_SKILL_BUY_REQ );								// 스킬 구입 요청
	...
	PACKETNAME_INSERT( UG_PARTY_OPEN_CHARM_SLOT_REQ );						// 파티 부적 등록창 열기
	PACKETNAME_INSERT( UG_PARTY_CLOSE_CHARM_SLOT_REQ );						// 파티 부적 등록창 닫기
	PACKETNAME_INSERT( UG_PARTY_REGISTER_VICTIM_ITEM_REQ );					// 부적 제물(아이템) 등록하기
	PACKETNAME_INSERT( UG_PARTY_UNREGISTER_VICTIM_ITEM_REQ );				// 등록된 부적 제물(아이템) 다시 가져오기
	PACKETNAME_INSERT( UG_PARTY_REGISTER_VICTIM_ZENNY_REQ );					// 부적 제물(제니) 등록하기
	PACKETNAME_INSERT( UG_PARTY_UNREGISTER_VICTIM_ZENNY_REQ );				// 등록된 부적 제물(제니) 다시 가져오기
	PACKETNAME_INSERT( UG_PARTY_DECLARE_ZENNY_REQ );							// 제니 등록하기
	PACKETNAME_INSERT( UG_PARTY_ACTIVATE_CHARM_REQ );						// 부적 활성화하기
	PACKETNAME_INSERT( UG_PARTY_DEACTIVATE_CHARM_REQ );						// 활성화된 부적 효과 제거하기
	...
	PACKETNAME_INSERT( UG_PARTY_INVEST_ZENNY_REQ );							// 제니를 파티 인벤토리의 아이템에 투자하기
	PACKETNAME_INSERT( UG_PARTY_INVEN_ITEM_RANK_SET_REQ );					// 파티인벤에 넣을 아이템의 RANK설정하기
	...
	PACKETNAME_INSERT( UG_TIMEQUEST_ROOM_LIST_REQ );							// 타임머신 퀘스트 방 목록 요청
	PACKETNAME_INSERT( UG_TIMEQUEST_ROOM_INFO_REQ );							// 타임머신 퀘스트 방 정보 요청
	PACKETNAME_INSERT( UG_TIMEQUEST_ROOM_JOIN_REQ );							// 타임머신 퀘스트 방 진입 요청
	PACKETNAME_INSERT( UG_TIMEQUEST_ROOM_LEAVE_REQ );						// 타임머신 퀘스트 방 퇴장 요청
	PACKETNAME_INSERT( UG_TIMEQUEST_ROOM_TELEPORT_REQ );						// 타임머신 퀘스트 시작 위치로 텔레포트
	...
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_LIST_REQ );						// RankBattle 방 목록 요청
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_INFO_REQ );						// RankBattle 방 정보 요청
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_CREATE_REQ );						// RankBattle 방 생성 요청
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_LEAVE_REQ );						// RankBattle 방 삭제 요청
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_CHALLENGE_REQ );					// RankBattle 대련 요청
	PACKETNAME_INSERT( UG_RANKBATTLE_ROOM_MATCH_CANCEL_REQ );				// RankBattle 대련 준비 완료 알림이 온 후 대련을 취소함(개인)
	...
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_REQUEST_REQ );				// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_CONSENT_RES );				// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY );			// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_REQ );		// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_REQ );	// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PRIVATESHOP_BUSINESS_CANCEL_REQ );					// [10/17/2007 SGpro]
	PACKETNAME_INSERT( UG_PORTAL_START_REQ );
	...
	PACKETNAME_INSERT( UG_PARTY_CHARM_DICE_ROLL_REQ );							// 파티참 등록 시 주사위 굴리기
	PACKETNAME_INSERT( UG_PARTY_INVEN_LOCK_REQ );
	PACKETNAME_INSERT( UG_PARTY_INVEN_RESET_REQ );
	PACKETNAME_INSERT( UG_PARTY_INVEN_ACCEPTED_REQ );
	PACKETNAME_INSERT( UG_PARTY_INVEN_GIVE_REQ );
	PACKETNAME_INSERT( UG_PARTY_INVEN_DICE_START_REQ );
	PACKETNAME_INSERT( UG_PARTY_INVEN_DICE_ROLL_REQ );					// 아이템 분배시 주사위 굴리기
	PACKETNAME_INSERT( UG_TELEPORT_CONFIRM_REQ );
	PACKETNAME_INSERT( UG_HOIPOIMIX_ITEM_CHECK_REQ );					// 만들아이템 선택 (필요한 아이템 수량 체크)
	PACKETNAME_INSERT( UG_HOIPOIMIX_ITEM_MAKE_REQ );						// 아이템 만들기
	PACKETNAME_INSERT( UG_HOIPOIMIX_ITEM_MAKE_EP_REQ );					// 아이템 만들기 중 EP 넣기
	PACKETNAME_INSERT( UG_HOIPOIMIX_ITEM_MACHINE_MAKE_REQ );				// 머신 만들기
	PACKETNAME_INSERT( UG_HOIPOIMIX_ITEM_MACHINE_DEL_REQ );				// 머신 삭제
	PACKETNAME_INSERT( UG_HOIPOIMIX_JOB_SET_REQ );						// 믹스 잡 세팅
	PACKETNAME_INSERT( UG_HOIPOIMIX_JOB_RESET_REQ );						// 믹스 잡 리셋
	PACKETNAME_INSERT( UG_VEHICLE_DIRECT_PLAY_CANCEL_NFY );
	PACKETNAME_INSERT( UG_VEHICLE_ENGINE_START_REQ );					// 탈 것 시동 켠다.
	PACKETNAME_INSERT( UG_VEHICLE_ENGINE_STOP_REQ );						// 탈 것 시동 끈다.
	...
	PACKETNAME_INSERT( UG_DOJO_BANK_HISTORY_REQ );
	...
	PACKETNAME_INSERT( UT_CHAT_MESSAGE_PRIVATESHOP_BUSINESS );				// 개인상점 흥정 대화 [10/31/2007 SGpro]
