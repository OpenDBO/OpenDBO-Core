...
RwBool CRankBoardGui::Create() 
{
	...
	if( !CNtlPLGui::Create("", dRANKBOARD_FILE_SURFACE , dRANKBOARD_FILE_FRAME ) )
		NTL_RETURN( FALSE );

	CNtlPLGui::CreateComponents(CNtlPLGuiManager::GetInstance()->GetGuiManager());

	// Get Component
	m_pThis = (gui::CDialog*)GetComponent( dRANKBOARD_COMPONENT_DIALOG_MAIN );
	m_pBtnClose = (gui::CButton*)GetComponent( dRANKBOARD_COMPONENT_BUTTON_CLOSE );
	m_pCbbTitle = (gui::CComboBox*)GetComponent( dRANKBOARD_COMPONENT_COMBOBOX_TITLE );
	...
	m_pCbbTitle->AddItem( GetDisplayStringManager()->GetString( DST_RANKBOARD_BOARD_TITLE_TMQ ) );
