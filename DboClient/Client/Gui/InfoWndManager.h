...
public:
	...
	enum eINFOWNDSTATE
	{
		INFOWND_NOTSHOW = 0,
		INFOWND_ITEM,							// 일반 아이템.		
		INFOWND_ITEM_DATA,						// sITEM_DATA 형태의 아이템.
		INFOWND_PROFILE_ITEM,					// 프로파일 형태의 아이템.	
		INFOWND_TABLE_ITEM,						// 테이블 상의 아이템
		INFOWND_JUST_ITEM_NAME,					// 아이템 이름만 출력
