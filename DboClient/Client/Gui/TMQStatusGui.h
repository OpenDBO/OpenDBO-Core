...
protected:		
	...
	CNumberGui			m_LeftTimeMinuteNumber;			///< 남은시간 분 표시
	CNumberGui			m_LeftTimeSecondNumber;			///< 남은시간 초 표시

	CNumberGui			m_RecordTimeMinuteNumber;		///< 최단시간 분 표시
	CNumberGui			m_RecordTimeSecondNumber;		///< 최단시간 초 표시

	gui::CStaticBox*	m_pDialogName;					///< 다이얼로그의 이름 스태틱
	gui::CStaticBox*	m_pLeftTime;					///< '남은시간'
	gui::CStaticBox*	m_pRecordTime;					///< '최단시간'
	...
	CSurfaceGui			m_srfRemainSemiColon;			///< TMQ 남은시간 세미콜론
	CSurfaceGui			m_srfRecordSemiColon;			///< TMQ 최단시간 세미콜론
