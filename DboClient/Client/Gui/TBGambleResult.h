...
// Define
#define dGAMBLERESULT_SLOT_OFF_X_FROM_SLOT 2
#define dGAMBLERESULT_SLOT_OFF_Y_FROM_SLOT 16

// File Locate
#define dGAMBLERESULT_FILE_SURFACE "gui\\TBGambleResult.srf"
#define dGAMBLERESULT_FILE_FRAME "gui\\TBGambleResult.frm"
