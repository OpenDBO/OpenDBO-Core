	...
	case eDBO_DOJO_STATUS_START:
		{
			...
			RwUInt32 uiStringIndex	= (RwUInt32)DST_DOJO_SCRAMBLE_STATE_RECEIVE +											
									  ((RwUInt32)byDojoState - (RwUInt32)eDBO_DOJO_STATUS_RECEIVE);

			WCHAR*	pwcText			= (WCHAR*)GetDisplayStringManager()->GetString(uiStringIndex);
