...
public:
	...
	VOID	SetCharmBuffInfo( sITEM_TBLDAT* pData );
	VOID    SetPortalInfo(RwUInt32 nPortalID, RwInt32 ePortalIconType, DWORD dwZenny);
	VOID	SetScouterInfo(SERIAL_HANDLE hScouterHandle);
...
private:
	...
	VOID	SetItemInfo_ScouterInfo( gui::CMDStaticBox* pmdBox, CNtlSobItem* pItem, sITEM_TBLDAT* pData );
	...
	VOID	SetItemInfo_LimitState( gui::CMDStaticBox* pmdBox, sITEM_TBLDAT* pData, CNtlSobItemAttr* pSobItemAttr = NULL, sITEM_PROFILE* pItemProfile = NULL );
	...
	VOID	SetSkillInfo_AppointApplySetString( RwInt32 nIndex, RwUInt8 byRange1 = 0, RwUInt8 byRange2 = 0, sSKILL_TBLDAT* pBaseData = NULL, RwInt32 i = 0 );
