...
RwBool COptionGraphic::Create( COptionWindowGui* pOptionWindow )
{
	...
	m_pScbGamma = (gui::CScrollBar*)GetComponent("scbGraphicGamma");		///< ��� ���� ��ũ�ѹ�
	...
	m_pStbObjectDist = (gui::CStaticBox*)GetComponent("stbObjectDist");		///< �繰 �þ߰Ÿ�
