...
#define EXP_EFFECT_SIZE_QUANTITY	1.5f		// 변하는 사이즈의 배율 1.0(실사이즈) ~ x
#define EXP_EFFECT_MOVE_TIME		1.0f
#define EXP_EFFECT_DELAY_TIME		0.2f		// 연속해서 나올때의 Delay
#define EXP_EFFECT_START_DELAY_TIME	2.0f		// 몹이 죽을때와 패킷과의 시간차를 보상.
