...
{
	RwInt32		nRank;												///< 순위
	WCHAR		awcName[NTL_MAX_SIZE_CHAR_NAME_UNICODE+1];			///< 캐릭터 이름
	RwInt32		nLevel;												///< 레벨
	RwUInt8		byClass;											///< 클래스
	WCHAR		awcGuildName[NTL_MAX_SIZE_GUILD_NAME_IN_UNICODE+1];	///< 길드 이름
	RwInt32		nPoint;												///< 점수
...
protected:
	...
	WCHAR				m_awcSearchName[NTL_MAX_SIZE_CHAR_NAME_UNICODE+1];
};
