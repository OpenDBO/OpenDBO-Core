...
public:
	...
	VOID	SetAbility( eICONPOS eIconPos, RwUInt8 byAbilityType, RwUInt32 uiValue, sSKILL_TBLDAT* pSkillTbl, RwBool bEnable = TRUE );
	VOID	SetMoveToolTipPos();
	VOID	SetToolTip( RwInt32 nX, RwInt32 nY, RwUInt8 byAbilityType, RwUInt32 uiValue, RwUInt8 byEffectType );
