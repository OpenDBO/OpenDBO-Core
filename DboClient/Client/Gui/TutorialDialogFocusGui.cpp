...
RwUInt32 CTutorialDialogFocus::ConvertIdicateTypetoDialog(RwUInt32 uiIndicateType)
{
	...
	case ETL_UI_INDICATOR_TYPE_SCOUTER_SLOT:			return DIALOG_SCOUTER_SLOT;
	...
	case ETL_UI_INDICATOR_TYPE_SCOUTER_POWERLEVEL:		return DIALOG_SCOUTER_MENU;
	case ETL_UI_INDICATOR_TYPE_SCOUTER_CLOSE_BTN:		return DIALOG_SCOUTER_MENU;
	}
