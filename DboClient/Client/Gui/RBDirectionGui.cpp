...
RwBool CRBDirectionGui::Create(VOID)
{
	...
	m_pdlgDirection = reinterpret_cast<gui::CDialog*>( GetComponent( "dlgDirection" ) );
	m_pflaTitle = reinterpret_cast<gui::CFlash*>( GetComponent( "flaTitle" ) );
	m_pflaKameTeam = reinterpret_cast<gui::CFlash*>( GetComponent( "flaKameTeam" ) );
	m_pflaTsuruTeam = reinterpret_cast<gui::CFlash*>( GetComponent( "flaTsuruTeam" ) );
	m_pflaVS = reinterpret_cast<gui::CFlash*>( GetComponent( "flaVS" )	);
	...
	for( RwInt32 i = 0 ; i < MAX_TEAM_MEMBER ; ++i )
	{
		...
		m_pflaKameTeamMember[i] = reinterpret_cast<gui::CFlash*>( GetComponent( buf ) );
		...
		m_pflaTsuruTeamMember[i] = reinterpret_cast<gui::CFlash*>( GetComponent( buf ) );
