...
VOID CBudokaiSideIconGui::HandleEvents( RWS::CMsg& msg )
{
	...
	else if( msg.Id == g_EventBudokaiUpdateMatchStateNfy )
	{
		...
		case BUDOKAI_MATCHSTATE_REGISTER:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_REGISTER ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_WAIT_MINOR_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_WAIT_MINOR_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_MINOR_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_MINOR_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_WAIT_MAJORMATCH_32:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_WAIT_MAJOR_MATCH ), 
				...
				GetDisplayStringManager()->GetString( uiStringId ), 
		...
		case BUDOKAI_MATCHSTATE_WAIT_SEMIFINAL_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_WAIT_SEMIFINAL_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_SEMIFINAL_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_SEMIFINAL_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_WAIT_FINAL_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_WAIT_FINAL_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_FINAL_MATCH:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_FINAL_MATCH ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		case BUDOKAI_MATCHSTATE_MATCH_END:
			swprintf_s( awcBuffer, 256, GetDisplayStringManager()->GetString( DST_BUDOKAI_NOTICE_END ), Logic_GetTBTypeString( byMainState ), GetDisplayStringManager()->GetString( uiStringId ) );
			break;
		}
