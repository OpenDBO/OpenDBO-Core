...
public:
	...
	enum COMMAND_ID { MERCHANT_COMMAND, SKILLTRAINER_COMMAND, BANKER_COMMAND, BUY_BANK_COMMAND, QUEST_COMMAND, UPGRADE_COMMAND, GUILD_COMMAND, TMQ_COMMAND,
					  ...
					  // guild contribution
					  GUILD_CONTRIBUTION_CONTRIBUTION_1000,		GUILD_CONTRIBUTION_CONTRIBUTION_5000,
					  GUILD_CONTRIBUTION_CONTRIBUTION_10000,	GUILD_CONTRIBUTION_CONTRIBUTION_50000,
					  GUILD_CONTRIBUTION_CONTRIBUTION_100000,

					  // guild function start
					  GUILDFUNCTION_MAX_MEMBER_20,				GUILDFUNCTION_MAX_SECOND_MASTER_1,
					  GUILDFUNCTION_NOTICE,						GUILDFUNCTION_POST,
					  GUILDFUNCTION_WAREHOUSE,					GUILDFUNCTION_MAX_MEMBER_30,
					  GUILDFUNCTION_MAX_SECOND_MASTER_2,		GUILDFUNCTION_MAX_MEMBER_40,
					  GUILDFUNCTION_CHANGE_NAME,				GUILDFUNCTION_MAX_MEMBER_50,
					  GUILDFUNCTION_MAX_SECOND_MASTER_3,		GUILDFUNCTION_CAN_SET_EMBLEM,
					  GUILDFUNCTION_MAX_MEMBER_60,				GUILDFUNCTION_MAX_MEMBER_70,
					  GUILDFUNCTION_MAX_SECOND_MASTER_4,		GUILDFUNCTION_CAN_HAVE_DOJO,
					  GUILDFUNCTION_USE_DOJO_TELEPORT,			GUILDFUNCTION_MAX_MEMBER_80,
					  GUILDFUNCTION_DOJO_UPGRADE_1,				GUILDFUNCTION_CAN_MAKE_DOGI,
					  GUILDFUNCTION_CAN_MAKE_DOJO_DOGI,			GUILDFUNCTION_CAN_CHANGE_EMBLEM,
					  GUILDFUNCTION_DOJO_UPGRADE_2,				GUILDFUNCTION_TENKAICHI_SEED,
					  GUILDFUNCTION_MAX_MEMBER_90,				GUILDFUNCTION_DOJO_UPGRADE_3,
					  GUILDFUNCTION_DOJO_QUEST_1,				GUILDFUNCTION_DOJO_MIX_RATE_UP_1,
					  GUILDFUNCTION_MAX_MEMBER_100,				GUILDFUNCTION_DOJO_UPGRADE_4,
					  GUILDFUNCTION_CAN_CHANGE_DOGI,			GUILDFUNCTION_CAN_CHANGE_DOJO_DOGI,
					  GUILDFUNCTION_DOJO_UPGRADE_5,				GUILDFUNCTION_DOJO_QUEST_2,
					  GUILDFUNCTION_DOJO_VEHICLE,				GUILDFUNCTION_DOJO_UPGRADE_6,
					  GUILDFUNCTION_CAN_HAVE_BOOK,				GUILDFUNCTION_DOJO_SKILL,
					  GUILDFUNCTION_DOJO_UPGRADE_7,				GUILDFUNCTION_DOJO_MIX_RATE_UP_2,
					  // guild function end

                      PORTAL_COMMAND, GAMBLE_BUY_COMMNAD, 
					  
					  // HoipoiMix Command
					  HOIPOIMIX_SKILL_SET_COMMAND, HOIPOIMIX_SKILL_RESET_COMMAND,

					  // HoipoiMix skill set function
					  HOIPOIMIX_SKILL_SET_FOOD_DRINK, HOIPOIMIX_SKILL_SET_MAIN_WEAPON,
					  HOIPOIMIX_SKILL_SET_ARMOR, HOIPOIMIX_SKILL_SET_ACCESSORY,
					  HOIPOIMIX_SKILL_SET_SCOUTER, HOIPOIMIX_SKILL_SET_SUB_WEAPON,

					  // HoipoiMix skill reset function
					  HOIPOIMIX_SKILL_RESET_NORAML,
					  HOIPOIMIX_SKILL_RESET_SPECIAL,

					  HOIPOIMIX_CREATE_COMMAND,
					  HOIPOIMIX_DESTROY_MACHINE_COMMAND,

					  BUY_PUBLIC_BAG = 0xFFFFFFFE, EXIT_COMMAND = 0xFFFFFFFF,
					  GUILDFUNCTION_START = GUILDFUNCTION_MAX_MEMBER_20};
	...
	VOID	SendHoipoiMixJobSetMenu(VOID);
	VOID	SendHoipoiMixJobResetMenu(VOID);
...
private:
	...
	VOID	ClearState_ClearAndMakeHoipoiMixJobSetMenu(VOID);
	VOID	ClearState_ClearAndMakeHoipoiMixJobResetMenu(VOID);
	...
	RwUInt32	m_uiId;				// Quest로 넘겨야 할 자료.
...
public:
	...
	enum NODE_TYPE { MULTIDIALOG_NODE, QUESTCATALOG_NODE, QUESTDIALOG_NODE, BRANCHDIALOG_NODE, GUILD_MODE, GUILDPOINT_MODE,
					 GUILDCONTRIBUTION_MODE, BUYBANK_MODE, SERVERSELECT_MODE, HOIPOIMIX_SET_MODE, HOIPOIMIX_RESET_MODE };
	//! Constructor & Destructor
