...
{
public:
	CCautionSideViewUnit(gui::CComponent* pParentGui, RwUInt32 uiStringID, const WCHAR* pwcString, RwReal fLimitTime);
...
protected:
	...
	RwBool	CreateUnit( RwUInt32 uiStringID, const WCHAR* pString, RwReal fLifeTime );
	RwBool	DestroyUnit( CCautionSideViewUnit* pUnit );
	RwBool	DestroyUnit( RwUInt32 uiStringID );
