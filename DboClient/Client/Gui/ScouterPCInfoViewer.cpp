...
RwBool CScouterPCInfoViewerGui::Create()
{
	...
	// 도복
	m_Item[EQUIP_SLOT_TYPE_COSTUME].SlotItem.Create(m_pThis, SDIALOG_SCOUTER_PC_VIEWER, REGULAR_SLOT_ITEM_TABLE);
	m_Item[EQUIP_SLOT_TYPE_COSTUME].SlotItem.SetPosition_fromParent(44, 285);
