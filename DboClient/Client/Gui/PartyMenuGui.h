...
public:	
	...
	typedef std::list<CPartyBuffGui*>				PARTYBUFF_LIST;
	typedef std::list<CPartyBuffGui*>::iterator		PARTYBUFF_ITER;
...
protected:
	...
	VOID		DisplayBuff(RwUInt8 byBuffIndex, RwUInt32 uiItemIndex);///< 부적 버프를 보여준다
	VOID		UnDisplayBuff(RwUInt8 byBuffIndex);					///< 부적 버프를 삭제한다	
	...
	VOID		SwitchCharmBuff(bool bOpen);
	...
	VOID		OnClick_PartyCharmButton(gui::CComponent* pComponent);
...
protected:
	...
	gui::CButton*		m_pPartyCharmButton;		///< 파티 부적 버튼
	...
	PARTYBUFF_LIST		m_listPartyBuff;
};