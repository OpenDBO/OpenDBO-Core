...
struct sRBBoardData
{
	RwUInt32		_uiFieldID;			// 데이터의 TableIndex;
	std::wstring	_wstrFieldName;		
	RwUInt32		_uiAppliedCount;
};
...
//! Operation
	...
	VOID	SetItemData( RwUInt32 uiFieldID, const WCHAR* pName, RwUInt32 uiAppliedCount );	
