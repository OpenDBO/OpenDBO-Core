...
#define	SDS_COUNT			0x00000001	///< 숫자를 표시한다
#define SDS_LOCK			0x00000002	///< 사용금지 이미지를 사용
#define SDS_DISABLE			0x00000004	///< 현재 조건이 맞지 않아 사용할 수 없다는 이미지 사용
...
public:
	...
	VOID			SetParentPosition(RwInt32 iX, RwInt32 iY);
	VOID			SetPosition_fromParent(RwInt32 iX, RwInt32 iY);
...
protected:
	...
	CNtlSobItem*			m_pSobItem;			///< SobItem 정보(Sob번호가 아니라면 NULL)
