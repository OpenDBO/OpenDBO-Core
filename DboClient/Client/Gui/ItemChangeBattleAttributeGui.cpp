...
{
	if (msg.Id == g_EventItemChangeBattleAttributeResult) // �ı���ߵ� ���Ը�ħ
	{
	...
	else if (msg.Id == g_EventNPCDialogOpen) // npc ��Ϣ���
	{
	...
	else if (msg.Id == g_EventSobItemDelete) // ɾ����ħ�ĵ���
	{
	...
	else if (msg.Id == g_EventMsgBoxResult) // �����ʼ��ħ
	{
...
VOID CItemChangeBattleAttributeGui::SetOfferItem(RwInt32 nSlotIdx, CNtlSobItem* pOfferItem)
{
	...
	// ������ ���׷��̵� ���ο��� �����϶� ���� ����Ʈ�� �����. DeleteHoipoiStone�� ���׷��̵� â���� ��������� ȣ��ȴ�. 
	if (m_pOfferItem)
	{
...
// peessiupgrade : Info window check ��Ϣ���ڼ��
