...
public:
	...
	// 출력될 안내 메시지
public:
	void SetGuideText( RwUInt32 uiColor, RwUInt32 uiStringID );
	...
	///< DisplayManager에서 GetString을 하기 위해 액션의 문자열 번호를 리턴
	RwUInt32 GetActionDisplayStringNum(RwUInt32 uiAction);
