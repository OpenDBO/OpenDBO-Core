...
public:
	  ...
	  typedef void (*APPLICATION_FILTER)( PEXCEPTION_POINTERS pExceptionInfo );
	  void SetApplicationFilter( APPLICATION_FILTER pApplicationFilter );
...
private:
      ...
      static TCHAR m_szLogFileName[NTL_MAX_DIR_PATH];
      static LPTOP_LEVEL_EXCEPTION_FILTER m_previousFilter;
      static FILE *m_pReportFile;
	  static APPLICATION_FILTER m_pApplicationFilter;
