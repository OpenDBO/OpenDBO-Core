...
void PacketHandler_GSRBInfoRes( void* pPacket )
{
	...
	{
		CNtlSLEventGenerator::SysMsg( INVALID_SERIAL_ID, pInfo->wResultCode );
		return;
	}
...
void PacketHandler_GSRBJoinRes( void* pPacket )
{
	...
	{
		CNtlSLEventGenerator::SysMsg( INVALID_SERIAL_ID, pJoin->wResultCode );
...
void PacketHandler_GSRBLeaveRes( void* pPacket )
{
	...
	{
		CNtlSLEventGenerator::SysMsg( INVALID_SERIAL_ID, pLeave->wResultCode );
		return;
	}
...
void PacketHandler_GSRBMatchStartNfy( void* pPacket )
{
	...
	if( pStart->wResultCode != GAME_SUCCESS )
		CNtlSLEventGenerator::SysMsg( INVALID_SERIAL_ID, pStart->wResultCode );
